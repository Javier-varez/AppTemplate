...
set(ARM_TARGET_CONFIG "-mcpu=cortex-m4 -mfloat-abi=hard -mthumb")
...
execute_process(COMMAND arm-none-eabi-gcc -mcpu=cortex-m4 -mfloat-abi=hard -mthumb -print-multi-directory
  OUTPUT_VARIABLE gcc_arm_multi_dir
  OUTPUT_STRIP_TRAILING_WHITESPACE)

# libgcc location
execute_process(COMMAND arm-none-eabi-gcc -mcpu=cortex-m4 -mfloat-abi=hard -mthumb -print-libgcc-file-name
